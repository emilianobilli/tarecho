...
class Transcoder(models.Model):
    ...
    slots           = models.IntegerField(blank=True, null=True, help_text="Availables Elemento slots")
    imen_slots      = models.IntegerField(blank=True, null=True, default = 0, help_text="Availables Imen slots")
...
class Preset(models.Model):
    ...
    type        = models.CharField(max_length=3, choices=TYPE, default='ELO', help_text="Preset type")
...
class Job(models.Model):
    ...
    type            = models.CharField(max_length=3, choices=TYPE, blank=True, null=True, help_text="Reserved field")
